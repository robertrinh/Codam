...
/*   Updated: 2025/02/24 17:18:51 by qtrinh        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief checks if the operator is correct
 * @param src takes a const reference to another object of the same class
 * @return a comparison which will return true if correct, false is not
 */
