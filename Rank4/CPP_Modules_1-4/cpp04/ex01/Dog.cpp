...
/*   Updated: 2025/03/21 17:10:53 by robertrinh    ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog(const Dog& src) : Animal(src), _brain(new Brain(*src._brain)) //* animal should be explicitly init in copy construct
{
