...
int main() 
{
    ...
    // std::cout << v4++ << std::endl; // prints {1, 2}, v4 becomes {2, 3}
    // std::cout << ++v4 << std::endl; // prints {3, 4}, v4 becomes {3, 4}
    // std::cout << v4-- << std::endl; // prints {3, 4}, v4 becomes {2, 3}
    // std::cout << --v4 << std::endl; // prints {1, 2}, v4 becomes {1, 2}
    // v2 += v3; // 2, 4
    // v1 -= v2; // -2, -4
    // v2 = v3 + v3 * 2; // 3, 6
    // v2 = 3 * v2; // 9, 18
